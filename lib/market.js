...
// Shared by /market and the homepage pay teaser so both hit one cache.
...
// Cached feed with a live self-heal: if the cache is holding an empty result
// (a transient BLS/GSA hiccup during a refresh), fetch live so the page heals
// on the next visit instead of showing the fallback all day.
