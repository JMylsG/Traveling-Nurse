    ...
    <footer id="site-footer">
      <div className="container">
        <div className="fgrid">
          ...
          <div className="fcol">
            ...
            <div className="socials">
              <a href="https://www.facebook.com/share/g/1BcxDjK3Q8/" target="_blank" rel="noopener noreferrer" aria-label="Facebook">
                <svg viewBox="0 0 24 24"><path d="M7 10v4h3v7h4v-7h3l1 -4h-4v-2a1 1 0 0 1 1 -1h3v-4h-3a5 5 0 0 0 -5 5v2h-3" /></svg>
              </a>
              <a href="https://www.linkedin.com/in/drew-jones-rn/" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn">
        ...
        <div className="fnote">
          ...
          <span><Link href="/privacy">Privacy</Link> · <Link href="/terms">Terms of Service</Link></span>
        </div>
      </div>
    </footer>
  );
